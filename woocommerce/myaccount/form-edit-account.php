...
<form class="shop-edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<div class="row row-gutter">
		<div class="col-md-6">
			<div class="form-group required">
				...
				<input type="text" class="input-text" name="account_first_name" id="account_first_name" autocomplete="given-name" value="<?php echo esc_attr( $user->first_name ); ?>" required />
				<i class="bar"></i>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group required">
				...
				<input type="text" class="input-text" name="account_last_name" id="account_last_name" autocomplete="family-name" value="<?php echo esc_attr( $user->last_name ); ?>" required />
				<i class="bar"></i>
			</div>
		</div>
	</div>
	...
	<fieldset class="mb">
		<legend class="tl"><?php esc_html_e( 'Password change', 'woocommerce' ); ?></legend>
